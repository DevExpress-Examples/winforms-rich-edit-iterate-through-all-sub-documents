...
'ORIGINAL LINE: this.updateFieldsBtn.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(this.updateFieldsBtn_ItemClick);
			' 
			' removeBookmarksBtn
			' 
...
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.removeBookmarksBtn.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(this.removeBookmarksBtn_ItemClick);
			' 
			' replaceTextBtn
			' 
...
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.replaceTextBtn.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(this.replaceTextBtn_ItemClick);
			' 
			' highlightBtn
			' 
...
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.highlightBtn.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(this.highlightBtn_ItemClick);
			' 
			' ribbonPage1
			' 
		...
		Private WithEvents updateFieldsBtn As DevExpress.XtraBars.BarButtonItem
		Private WithEvents removeBookmarksBtn As DevExpress.XtraBars.BarButtonItem
		Private WithEvents replaceTextBtn As DevExpress.XtraBars.BarButtonItem
		Private ribbonPage1 As DevExpress.XtraBars.Ribbon.RibbonPage
		Private ribbonPageGroup1 As DevExpress.XtraBars.Ribbon.RibbonPageGroup
		Private WithEvents highlightBtn As DevExpress.XtraBars.BarButtonItem
	End Class
End Namespace
