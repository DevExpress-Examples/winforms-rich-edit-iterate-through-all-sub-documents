...
namespace SubDocumentIterator
{
    class Program
    {
        ...
        static private void AskAction(Document document)
        {
            ...
            if (answer == "1") { document.ForEachSubDocument((subdoc => { subdoc.Fields.Update(); })); }
            ...
            if (answer == "3") { document.ForEachSubDocument((subdoc => { subdoc.ReplaceAll("test text", "Hello!!!", SearchOptions.None); })); }
